        ...
        <div className="h-full container-responsive">
          <div className="flex items-center justify-between h-full">
            ...
            <div className="hidden md:flex items-center gap-1 lg:gap-2">
              ...
              <button
                onClick={toggleTheme}
                className="p-2 rounded-lg hover:bg-base-200/50 transition-colors duration-300"
                aria-label="Toggle theme"
              >
                {theme === 'portfolioLight' ? (
        ...
        <div className="container-responsive py-3">
          <div className="flex flex-col space-y-1">
            ...
            <button
              ...
              className="px-4 py-3 text-base font-medium rounded-lg
                       hover:bg-base-200/50 transition-colors duration-300 flex items-center gap-3"
            >
              {theme === 'portfolioLight' ? (
                <>
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
